...
import { refreshRequestSchema } from "../../../../src/api/contracts";
...
export async function POST(request: NextRequest) {
  ...
  const handler = createJsonHandler(refreshRequestSchema, ({ licenseId, ...input }) => licenseService().validate(licenseId, input, "refreshed"));
