...
<style scoped>
.panel{padding:18px;display:grid;gap:20px}.panel h3,.panel p{margin:0}.panel header p,.path{font-size:12px;color:var(--muted);word-break:break-all}.panel section{display:grid;gap:10px}.actions{display:flex;gap:8px}.panel :deep(.phone-canvas){margin:auto;width:150px}
</style>
