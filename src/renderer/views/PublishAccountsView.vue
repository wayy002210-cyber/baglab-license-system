...
<style scoped>
.panel{padding:26px;min-height:590px}.notice{padding:15px 18px;border-radius:12px;background:#fff9d7;color:#5a5220}.metrics{display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin:18px 0}.metrics div{display:grid;gap:5px;padding:20px;border:1px solid #e9e8e1;border-radius:16px}.metrics strong{font-size:28px}.metrics span{color:var(--text-muted)}.green{color:#2b8a57}.orange{color:#c06c00}.toolbar{display:grid;grid-template-columns:auto minmax(220px,1fr) 160px auto;gap:12px;align-items:center;margin-bottom:20px}.cards{display:grid;grid-template-columns:repeat(auto-fill,minmax(330px,1fr));gap:16px}.card{display:flex;flex-direction:column;padding:20px;border:1px solid #e5e5dd;border-radius:18px;background:#fff}.card header{display:flex;justify-content:space-between;gap:12px}.card h3{margin:5px 0}.platform{color:#1769e0;font-weight:700}.card dl{display:grid;gap:10px}.card dl div{display:grid;grid-template-columns:82px 1fr;gap:8px}.card dt{color:#8b8b83}.card dd{margin:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.card footer{display:flex;gap:8px;margin-top:auto;padding-top:16px}.card footer .el-button{margin:0}.delete{margin-left:auto!important;border-radius:10px}@media(max-width:980px){.toolbar{grid-template-columns:1fr 1fr}.metrics{grid-template-columns:1fr}}
</style>
