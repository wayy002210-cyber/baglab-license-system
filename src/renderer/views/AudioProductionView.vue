...
<style scoped>
.audio-grid{display:grid;grid-template-columns:minmax(0,1fr) 300px;gap:24px;padding:28px}.audio-main{display:grid;gap:22px}.audio-actions{border-left:1px solid var(--line);padding-left:22px}.wide{width:100%;margin:0 0 12px}.next{margin-top:28px}.control-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:18px}.control-grid label{display:grid;gap:8px;color:var(--muted)}.audio-toolbar{display:flex;align-items:center;justify-content:space-between;gap:18px;padding:18px;border-radius:16px;background:#fff8bf}.audio-toolbar p{margin:4px 0 0;color:var(--muted);font-size:13px}.generation-error{padding:10px 12px;border-radius:10px;color:#b42318;background:#fff0ef}.section-heading{display:flex;justify-content:space-between}.section-heading div{display:grid;gap:4px}.section-heading small{color:var(--muted)}.voice-chips{display:flex;flex-wrap:wrap;gap:10px;margin-top:12px}.voice-chips button{padding:12px 16px;border:1px solid var(--line);border-radius:12px;background:white}.voice-chips button.active{background:#111;color:#fff;border-color:#111}.voice-chips span{display:block;font-size:11px;color:#888}.segment-card{display:grid;grid-template-columns:32px 1fr auto auto auto;gap:10px;align-items:center;border:1px solid var(--line);border-radius:14px;padding:12px;margin-top:10px}.segment-index{width:28px;height:28px;border-radius:50%;display:grid;place-items:center;background:var(--brand);color:#111;font-weight:800}.clone-form{display:grid;gap:12px}.path-row{display:flex;gap:10px}@media(max-width:980px){.audio-grid{grid-template-columns:1fr}.audio-actions{border-left:0;border-top:1px solid var(--line);padding:18px 0 0}.control-grid{grid-template-columns:1fr}.audio-toolbar{align-items:stretch;flex-direction:column}}
</style>
